...
class Send_Data_Payment(number: String, pass: String, listener: Response.Listener<String>) : StringRequest(Request.Method.POST,
    ...
    companion object {
        ...
        private val Send_data_url = URLContract.URLEntry.BASE_UEL + "payment.php"
    }
